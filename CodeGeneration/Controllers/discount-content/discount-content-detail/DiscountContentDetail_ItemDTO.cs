...
{
    public class DiscountContentDetail_ItemDTO : DataDTO
    {
        ...
        public DiscountContentDetail_ItemDTO() {}
        public DiscountContentDetail_ItemDTO(Item Item)
        {
    ...
    public class DiscountContentDetail_ItemFilterDTO : FilterDTO
    {
