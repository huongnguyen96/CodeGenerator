...
{
    public class StockMaster_UnitDTO : DataDTO
    {
        ...
        public StockMaster_UnitDTO() {}
        public StockMaster_UnitDTO(Unit Unit)
        {
    ...
    public class StockMaster_UnitFilterDTO : FilterDTO
    {
