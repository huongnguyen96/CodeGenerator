...
{
    public class EVoucherDetail_ProductDTO : DataDTO
    {
        ...
        public EVoucherDetail_ProductDTO() {}
        public EVoucherDetail_ProductDTO(Product Product)
        {
    ...
    public class EVoucherDetail_ProductFilterDTO : FilterDTO
    {
