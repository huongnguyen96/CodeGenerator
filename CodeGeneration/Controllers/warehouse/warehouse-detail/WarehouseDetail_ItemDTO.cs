...
{
    public class WarehouseDetail_ItemDTO : DataDTO
    {
        ...
        public WarehouseDetail_ItemDTO() {}
        public WarehouseDetail_ItemDTO(Item Item)
        {
    ...
    public class WarehouseDetail_ItemFilterDTO : FilterDTO
    {
