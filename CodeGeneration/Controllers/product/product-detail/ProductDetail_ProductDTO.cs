...
{
    public class ProductDetail_ProductDTO : DataDTO
    {
        ...
        public ProductDetail_ProductDTO() {}
        public ProductDetail_ProductDTO(Product Product)
        {
    ...
    public class ProductDetail_ProductFilterDTO : FilterDTO
    {
