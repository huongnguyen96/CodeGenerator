...
{
    public class ProductMaster_ProductDTO : DataDTO
    {
        ...
        public ProductMaster_ProductDTO() {}
        public ProductMaster_ProductDTO(Product Product)
        {
    ...
    public class ProductMaster_ProductFilterDTO : FilterDTO
    {
