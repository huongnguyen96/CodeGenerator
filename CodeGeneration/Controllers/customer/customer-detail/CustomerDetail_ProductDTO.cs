...
{
    public class CustomerDetail_ProductDTO : DataDTO
    {
        ...
        public CustomerDetail_ProductDTO() {}
        public CustomerDetail_ProductDTO(Product Product)
        {
    ...
    public class CustomerDetail_ProductFilterDTO : FilterDTO
    {
