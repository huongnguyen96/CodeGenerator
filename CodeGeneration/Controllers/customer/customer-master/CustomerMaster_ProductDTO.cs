...
{
    public class CustomerMaster_ProductDTO : DataDTO
    {
        ...
        public CustomerMaster_ProductDTO() {}
        public CustomerMaster_ProductDTO(Product Product)
        {
    ...
    public class CustomerMaster_ProductFilterDTO : FilterDTO
    {
