...
{
    public class WardDetail_ShippingAddressDTO : DataDTO
    {
        ...
        public WardDetail_CustomerDTO Customer { get; set; }
        public WardDetail_DistrictDTO District { get; set; }
        public WardDetail_ProvinceDTO Province { get; set; }
        public WardDetail_ShippingAddressDTO() {}
    ...
    public class WardDetail_ShippingAddressFilterDTO : FilterDTO
    {
