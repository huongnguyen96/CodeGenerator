...
{
    public class VariationMaster_ProductDTO : DataDTO
    {
        ...
        public VariationMaster_ProductDTO() {}
        public VariationMaster_ProductDTO(Product Product)
        {
    ...
    public class VariationMaster_ProductFilterDTO : FilterDTO
    {
