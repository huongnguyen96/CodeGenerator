...
{
    public class VariationDetail_ProductDTO : DataDTO
    {
        ...
        public VariationDetail_ProductDTO() {}
        public VariationDetail_ProductDTO(Product Product)
        {
    ...
    public class VariationDetail_ProductFilterDTO : FilterDTO
    {
