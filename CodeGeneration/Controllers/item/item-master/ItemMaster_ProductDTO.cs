...
{
    public class ItemMaster_ProductDTO : DataDTO
    {
        ...
        public ItemMaster_ProductDTO() {}
        public ItemMaster_ProductDTO(Product Product)
        {
    ...
    public class ItemMaster_ProductFilterDTO : FilterDTO
    {
