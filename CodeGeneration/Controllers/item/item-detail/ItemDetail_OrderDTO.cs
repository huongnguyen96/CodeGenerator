...
{
    public class ItemDetail_OrderDTO : DataDTO
    {
        ...
        public ItemDetail_OrderDTO() {}
        public ItemDetail_OrderDTO(Order Order)
        {
    ...
    public class ItemDetail_OrderFilterDTO : FilterDTO
    {
