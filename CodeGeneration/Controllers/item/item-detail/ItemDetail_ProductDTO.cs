...
{
    public class ItemDetail_ProductDTO : DataDTO
    {
        ...
        public ItemDetail_ProductDTO() {}
        public ItemDetail_ProductDTO(Product Product)
        {
    ...
    public class ItemDetail_ProductFilterDTO : FilterDTO
    {
