...
{
    public class OrderDetail_ItemDTO : DataDTO
    {
        ...
        public OrderDetail_ItemDTO() {}
        public OrderDetail_ItemDTO(Item Item)
        {
    ...
    public class OrderDetail_ItemFilterDTO : FilterDTO
    {
