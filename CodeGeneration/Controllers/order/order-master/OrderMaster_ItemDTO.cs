...
{
    public class OrderMaster_ItemDTO : DataDTO
    {
        ...
        public OrderMaster_ItemDTO() {}
        public OrderMaster_ItemDTO(Item Item)
        {
    ...
    public class OrderMaster_ItemFilterDTO : FilterDTO
    {
