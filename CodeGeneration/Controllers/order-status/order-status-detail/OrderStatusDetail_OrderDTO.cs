...
{
    public class OrderStatusDetail_OrderDTO : DataDTO
    {
        ...
        public OrderStatusDetail_CustomerDTO Customer { get; set; }
        public OrderStatusDetail_OrderDTO() {}
        public OrderStatusDetail_OrderDTO(Order Order)
        {
            ...
            this.Customer = new OrderStatusDetail_CustomerDTO(Order.Customer);

        }
    }

    public class OrderStatusDetail_OrderFilterDTO : FilterDTO
    {
