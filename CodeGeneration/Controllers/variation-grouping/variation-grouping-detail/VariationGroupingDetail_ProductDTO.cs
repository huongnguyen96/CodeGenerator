...
{
    public class VariationGroupingDetail_ProductDTO : DataDTO
    {
        ...
        public VariationGroupingDetail_ProductDTO() {}
        public VariationGroupingDetail_ProductDTO(Product Product)
        {
    ...
    public class VariationGroupingDetail_ProductFilterDTO : FilterDTO
    {
