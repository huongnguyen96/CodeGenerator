...
{
    public class VariationGroupingMaster_ProductDTO : DataDTO
    {
        ...
        public VariationGroupingMaster_ProductDTO() {}
        public VariationGroupingMaster_ProductDTO(Product Product)
        {
    ...
    public class VariationGroupingMaster_ProductFilterDTO : FilterDTO
    {
