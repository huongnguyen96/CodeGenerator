...
{
    public class EVoucherContentDetail_EVoucherDTO : DataDTO
    {
        ...
        public EVoucherContentDetail_EVoucherDTO() {}
        public EVoucherContentDetail_EVoucherDTO(EVoucher EVoucher)
        {
    ...
    public class EVoucherContentDetail_EVoucherFilterDTO : FilterDTO
    {
