...
{
    public class EVoucherContentMaster_EVoucherDTO : DataDTO
    {
        ...
        public EVoucherContentMaster_EVoucherDTO() {}
        public EVoucherContentMaster_EVoucherDTO(EVoucher EVoucher)
        {
    ...
    public class EVoucherContentMaster_EVoucherFilterDTO : FilterDTO
    {
