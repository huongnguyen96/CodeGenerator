...
{
    public class DiscountDetail_ItemDTO : DataDTO
    {
        ...
        public DiscountDetail_ItemDTO() {}
        public DiscountDetail_ItemDTO(Item Item)
        {
    ...
    public class DiscountDetail_ItemFilterDTO : FilterDTO
    {
